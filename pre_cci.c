# 1 "c:\\multirunner\\ibase_update1\\\\combined_ibase_update1.c"
...
# 1 "c:\\multirunner\\ibase_update1\\\\combined_ibase_update1.c" 2
...
# 2 "c:\\multirunner\\ibase_update1\\\\combined_ibase_update1.c" 2
...
# 3 "c:\\multirunner\\ibase_update1\\\\combined_ibase_update1.c" 2
...
# 4 "c:\\multirunner\\ibase_update1\\\\combined_ibase_update1.c" 2
...
web_set_sockets_option("IGNORE_PREMATURE_SHUTDOWN", "1");
   ...
   ibasedetail()
    ...
    web_save_header("RESPONSE", "headerVal");
        ...
        lr_end_transaction(lr_eval_string(lr_eval_string("{MName}")), 2);
   ...
   ibasepartner()
{
	...
	strncpy(statusCode, lr_eval_string("{headerVal}"), 12);
		...
		{
			if (( fileOutHandle = fopen(lr_eval_string("{DirPath}"), "a")) == 0 ) 
            	{
...
# 5 "c:\\multirunner\\ibase_update1\\\\combined_ibase_update1.c" 2
...
# 6 "c:\\multirunner\\ibase_update1\\\\combined_ibase_update1.c" 2
